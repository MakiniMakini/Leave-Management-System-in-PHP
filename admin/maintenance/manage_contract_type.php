...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    $qry = $conn->query("SELECT * from `contract_list` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<form action="" id="contract-form">
		...
		<div class="form-group">
			<label for="name" class="control-label">Contract</label>
...
var _this = $(this)
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_contract",
