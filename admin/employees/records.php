            ...
            <div class="col-md-4 col-sm-12">
                <div class="callout border-0">
                    ...
                    <div class="float-right">
                        <button class="btn btn-sm btn-default bg-orange rounded-circle text-center" type="button" id="manage_leave"><span class="fa fa-cog"></span></button>
                    </div>
                    <?php endif; ?>
                    ...
                    <table class="table table-hover ">
                        ...
                        while($row=$lt->fetch_assoc()):
                            ...
                            # number of earned days
                            $earned = floor((time() - strtotime($doe)) / (60 * 60 * 24));
                            if ($allowed == 30) {
                                $earned = $earned * 0.08219178;
                            } elseif ($allowed == 8) {
                                $earned = $earned * 0.08888889;
                            } else {                               
                                $earned = $allowed;
                            }
