        ...
        <div class="container-fluid">
			<table class="table table-hover table-stripped">
				...
				<tbody>
					...
					$cont_arr = array_column($contract_qry->fetch_all(MYSQLI_ASSOC),'name','id');
						...
						<tr>
							...
							<td >
								<p class="m-0 ">
									...
									<b>Contract type: </b><?php echo isset($cont_arr[$row['contract_id']]) ? $cont_arr[$row['contract_id']] : 'N/A' ?><br>
								</p>
							</td>
							<td align="center">
